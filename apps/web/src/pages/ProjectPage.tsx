...
type ProjectTab = 'overview' | 'deployments' | 'previews' | 'domains' | 'environment' | 'settings';
...
const projectTabs: ProjectTab[] = ['overview', 'deployments', 'previews', 'domains', 'environment', 'settings'];
